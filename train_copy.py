...
def train(dataset, model, args, same_feat=True, val_dataset=None, test_dataset=None, writer=None,
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch_idx, data in enumerate(dataset):
            ...
            # nhu nay moi dung, a k biet len(data) co tinh dc k, em nhan loss voi size cua batch o day
        ...
        if test_dataset is not None:
            test_result_ = evaluate(test_dataset, model, args, name='Test')
...
def benchmark_task_val(args, writer=None, feat='node-feat'):
    ...
    if os.path.exists('graph.pkl'):
        ...
        graphs, gene_locus_int = load_data_.get_graphs(num_test_graphs=1)
